               ...
               <div class="option-container">
				...
				<div id="sociallinks">
					...
					<table class="form-table">
						...
						?>
							<tr>
								<th scope="row" style="padding: 0px;"><h4><?php printf( __( '%s', 'cleanretina' ), $key ); ?></h4></th>
				...
				<div id="webmastertools">
					<div class="option-container">
						<h3 class="option-toggle"><a href="#"><?php _e( 'Site Verification', 'cleanretina' ); ?></a></h3>
						<div class="option-content inside">
							<table class="form-table">  
								<tbody>    
									<tr>
										<th scope="row"><label><?php _e( 'Google Site Verification ID', 'cleanretina' ); ?></label></th>
										<td><input type="text" size="45" name="cleanretina_theme_options[google_verification]" value="<?php echo esc_attr( $options[ 'google_verification' ] ); ?>" /> <?php _e('Enter your Google ID number only', 'cleanretina'); ?>
										</td>
									</tr>

									<tr> 
										<th scope="row"><label><?php _e( 'Yahoo Site Verification ID', 'cleanretina' ); ?></label></th>
										<td><input type="text" size="45" name="cleanretina_theme_options[yahoo_verification]" value="<?php echo esc_attr( $options[ 'yahoo_verification'] ); ?>" /> <?php _e('Enter your Yahoo ID number only', 'cleanretina'); ?>
										</td>
									</tr>

									<tr>
										<th scope="row"><label><?php _e( 'Bing Site Verification ID', 'cleanretina' ); ?></label></th>
										<td><input type="text" size="45" name="cleanretina_theme_options[bing_verification]" value="<?php echo esc_attr( $options[ 'bing_verification' ] ); ?>" /> <?php _e('Enter your Bing ID number only', 'cleanretina'); ?>
										</td>
									</tr>
								</tbody>
							</table>
